...
public class EnderecoResource {
	...
	@GetMapping(value = "/usuario/{usuario_id}")
	public ResponseEntity<List<Endereco>> findByUsuarioId(@PathVariable Long usuario_id) {
		List<Endereco> list = service.findByUsuarioId(usuario_id);
		return ResponseEntity.ok().body(list);
	}
	@PostMapping
